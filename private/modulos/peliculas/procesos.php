...
class pelicula{
    ...
    private function validar_datos(){
        if( empty($this->datos['nombre']) ){
            $this->respuesta['msg'] = 'Ingrese el nombre de la pelicula';
        }
        if( empty($this->datos['descripcion']) ){
            $this->respuesta['msg'] = 'Ingrese la descripcion de la pelicula';
        }
         if( empty($this->datos['sinopsis']) ){
            $this->respuesta['msg'] = 'Ingrese sinopsis de la pelicula';
        }
        if( empty($this->datos['genero']) ){
            $this->respuesta['msg'] = 'Ingrese genero de la pelicula';
        }
         if( empty($this->datos['duracion']) ){
            $this->respuesta['msg'] = 'Ingrese duracion de la pelicula';
        }
