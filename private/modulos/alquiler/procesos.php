...
class alquiler{
    ...
    private function validar_datos(){
        if( empty($this->datos['idPelicula']) ){
            $this->respuesta['msg'] = 'Ingrese ID de la pelicula';
        }
        if( empty($this->datos['idCliente']) ){
            $this->respuesta['msg'] = 'Ingrese ID del cliente';
        }
        if( empty($this->datos['fechaPrestamo']) ){
            $this->respuesta['msg'] = 'Ingrese fecha de Prestamo';
        }
        if( empty($this->datos['fechaDevolucion']) ){
            $this->respuesta['msg'] = 'Ingrese fecha de Devolucion';
        }
        if( empty($this->datos['valor']) ){
            $this->respuesta['msg'] = 'Ingrese el valor del alquiler';
        }
